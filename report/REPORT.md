...
1. Phân loại ảnh
    Ground truth: 1 nhãn duy nhất (class_id, class_name).
    Điểm mơ hồ: Ảnh có nhiều chủ thể, khó xác định đối tượng chính.
    Annotator: Chọn 1 lớp theo đúng guideline.
    Reviewer: Kiểm tra nhãn có đúng nội dung chính của ảnh hay không.
2. Phát hiện vật thể
    Ground truth: 1 bounding box (xyxy) + 1 lớp cho mỗi vật thể.
    Điểm mơ hồ: Vật thể nhỏ, chồng lấp, bị che hoặc bị bỏ sót.
    Annotator: Vẽ box ôm sát từng vật thể và gán đúng lớp.
    Reviewer: Kiểm tra đủ số lượng vật thể, đúng lớp và box có chặt không.
3. Instance Segmentation
    Ground truth: 1 mask/polygon + 1 lớp cho mỗi instance. 
    Điểm mơ hồ: Biên mờ, vật thể tiếp xúc nhau, che khuất.
    Annotator: Vẽ mask bám sát phần nhìn thấy của vật thể.
    Reviewer: Kiểm tra mask chính xác, không lấn nền và tách đúng từng instance.
